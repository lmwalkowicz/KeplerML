# runs the gradient boosting classifier with a one-vs-one system
...
print "Gradient Boosting Classifier, One vs. One"
for i in range(1,2):
    if i==1 or i==3:
        X_train = training2
    ...
    y_pred = OneVsOneClassifier(gbc).fit(X_train, y_train).predict(X_test)
