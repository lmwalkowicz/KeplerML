# builds a training set and test set with quiescent stars
# instead of chunks of the general population
# and running a Gaussian naive Bayes classifier
# also prints the posterior probabilities
